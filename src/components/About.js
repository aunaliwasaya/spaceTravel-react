...
const About = () => {
  return (
    ...
    <section name='about' className='w-full md:h-screen flex flex-col justify-center items-center bg-[#000000fe] px-6 py-20 '>

{/* <div     className='w-full h-screen bg-cover bg-center bg-fixed py-20'
      style={{ backgroundImage: 'url(https://heatherimacleod.wordpress.com/wp-content/uploads/2014/03/space-facebook-cover.jpg?w=640)' }}> */}
        

        <h1 className='text-3xl text-center font-semibold text-slate-100'>A Growing Protocol Ecosystem</h1>

        <p className='text-white text-center py-2 pb-10'>The Defi protocol system empire developer.The bird eyes of for air. And prophet velvet is.</p>
