  ...
  return (
    <section name="support" className="w-full bg-slate-100">
      ...
      <div className="w-9/12 mx-auto">
        <h1 className="text-center py-4 text-3xl font-bold text-gray-500 uppercase">
          Support
        </h1>
      ...
      <div className="w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-800 rounded-md space-y-4 p-4 my-6 shadow-lg shadow-green-300">
          <BsLaptop
            size={50}
            className=" p-2 bg-green-500 rounded-full mt-[-40px]"
          />
          ...
          <p className="text-slate-300 pb-2">
            ...
            harum. Reiciendis optio perspiciatis ut corrupti molestiae eligendi
            sit perferendis quos!
          </p>
        </div>
